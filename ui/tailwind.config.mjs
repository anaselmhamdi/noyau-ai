...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Type scale per visual identity — refined for editorial precision
      ...
      boxShadow: {
        ...
        'card-lifted': '0 8px 24px -8px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(34, 211, 238, 0.1)',
        'glow': '0 0 20px rgba(34, 211, 238, 0.15)',
        'glow-subtle': '0 0 12px rgba(34, 211, 238, 0.08)',
        'inner-subtle': 'inset 0 1px 0 rgba(255, 255, 255, 0.02)',
      },
      animation: {
